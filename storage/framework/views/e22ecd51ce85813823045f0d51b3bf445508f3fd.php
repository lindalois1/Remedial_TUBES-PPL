            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    <?php if($latest['sale_price']>0): ?>
                        <div class="price">
                            <strike style="color: #761b18;">BDT <?php echo e($latest['price']); ?></strike>
                            <span style="color: #2d995b">BDT <?php echo e($latest['sale_price']); ?></span>
                        </div>
                        <a href="<?php echo e(route('products.productshop')); ?>" class="btn btn-outline-success">ORDER NOW</a>
                    <?php else: ?>
                        <div class="price">BDT <?php echo e($latest['price']); ?></div>
                        <a href="<?php echo e(route('products.productshop')); ?>" class="btn btn-outline-success">ORDER NOW</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    <?php if($product['sale_price']>0): ?>
                        <div class="price">
                            <strike style="color: #761b18;">BDT <?php echo e($product['price']); ?></strike>
                            <span style="color: #2d995b">BDT <?php echo e($product['sale_price']); ?></span>
                        </div>
                        <a href="<?php echo e(route('products.productshop')); ?>" class="btn btn-outline-success">ORDER NOW</a>
                    <?php else: ?>
                        <div class="price">BDT <?php echo e($product['price']); ?></div>
                        <a href="<?php echo e(route('products.productshop')); ?>" class="btn btn-outline-success">ORDER NOW</a>
                    <?php endif; ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_website_cake_shop_project\resources\views/welcome.blade.php ENDPATH**/ ?>